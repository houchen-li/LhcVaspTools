...
import argparse
from LhcVaspTools.BasicUtils import Vaspdata, ElecDnstyCrsSec
...
def main() -> int:
    ...
    elec_dnsty_crs_sec.loadVaspdata(vasp_data, num_of_grids)
    elec_dnsty_crs_sec.energy_level = energy_level
    elec_dnsty_crs_sec.sigma = sigma
    elec_dnsty_crs_sec.saveFile(output_file_name)
    return 0
